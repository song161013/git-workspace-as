...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private final ActivityFragmentLifecycle_ lifecycle;
    ...
    public SupportRequestManagerFragment() {
        this(new ActivityFragmentLifecycle_());
    }

    // For testing only.
    @SuppressLint("ValidFragment")
    public SupportRequestManagerFragment(ActivityFragmentLifecycle_ lifecycle) {
    ...
    ActivityFragmentLifecycle_ getLifecycle_() {
        return lifecycle;
    }
