...
public class HttpProxyCacheServer {
    ...
    private static final Logger LOG = LoggerFactory.getLogger("AA HttpProxyCacheServer");
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            LOG.info("AA Proxy cache server started. Is it alive? " + isAlive());
        } catch (IOException | InterruptedException e) {
            socketProcessor.shutdown();
            throw new IllegalStateException("AA Error starting local proxy server", e);
        }
    }
