...
public abstract class AbstractPanelListAdapter_origin {
     ...
     */
    public AbstractPanelListAdapter_origin(Context context, PanelListLayout pl_root, ListView lv_content) {
