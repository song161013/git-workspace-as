package com.android.hipermission;
...
import com.android.hipermission.libary.HiPermission;
import com.android.hipermission.libary.PermissionCallback;
import com.android.hipermission.libary.PermissionItem;
import com.main.app.R;

import java.util.ArrayList;
import java.util.List;

public class HipermissionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hipermisson_main);
    ...
    private void showToast(String text) {
        Toast.makeText(HipermissionActivity.this, text, Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn1:
                ...
                HiPermission.create(HipermissionActivity.this).animStyle(R.style.PermissionAnimFade)
            ...
            case R.id.btn2:
                ...
                HiPermission.create(HipermissionActivity.this)
...
//                        .style(R.style.CusStyle)
            ...
            case R.id.btn4:
                ...
                HiPermission.create(HipermissionActivity.this).checkSinglePermission(Manifest.permission.CAMERA, new PermissionCallback() {
                    @Override
                    public void onClose() {
