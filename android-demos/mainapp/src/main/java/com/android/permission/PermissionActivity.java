...
public class PermissionActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        switch (v.getId()){
            ...
            case R.id.btn2:
                ...
                if (mPermissionList.isEmpty()) {//未授予的权限为空，表示都授予了
                    Toast.makeText(PermissionActivity.this,"已经授权",Toast.LENGTH_LONG).show();
                } else {//请求权限方法
                    String[] permissions = mPermissionList.toArray(new String[mPermissionList.size()]);//将List转为数组
                    ActivityCompat.requestPermissions(PermissionActivity.this, permissions, MY_PERMISSIONS_REQUEST_CALL_CAMERA);
                }
                break;
            case R.id.btn3:
    ...
    private void showToast(String string){
        Toast.makeText(PermissionActivity.this,string,Toast.LENGTH_LONG).show();
    }
