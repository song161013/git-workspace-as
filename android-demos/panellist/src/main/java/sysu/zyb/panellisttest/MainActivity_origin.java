 ...
 * @author zyb
 */
public class MainActivity_origin extends AppCompatActivity {
...
//      adapter.setTitle("example");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.id_menu_next:
                Intent intent = new Intent(MainActivity_origin.this, RoomActivity.class);
    ...
    private void initView() {
        ...
        lv_content.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(MainActivity_origin.this, "你选中的position为：" + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public class CustomRefreshListener implements SwipeRefreshLayout.OnRefreshListener{
        ...
        public void onRefresh() {
            ...
            Toast.makeText(MainActivity_origin.this, "custom SwipeRefresh listener", Toast.LENGTH_SHORT).show();
    ...
    private List<String> getRowDataList(){
        ...
        rowDataList.add("第九列");
        rowDataList.add("第十列");
//        rowDataList.add("第十一列");
//        rowDataList.add("第十二列");
//        rowDataList.add("第十三列");
//        rowDataList.add("第十四列");
        return rowDataList;
    }
    ...
    private void initContentDataList() {
        for (int i = 1; i <= 50; i++) {
            ...
            data.put("9", "第" + i + "第九个");
            data.put("10", "第" + i + "第十个");
//            data.put("11", "第" + i + "第十一个");
//            data.put("12", "第" + i + "第十二个");
    ...
    private class MultiChoiceModeCallback implements ListView.MultiChoiceModeListener {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            if (actionBarView == null) {
                actionBarView = LayoutInflater.from(MainActivity_origin.this).inflate(R.layout.actionbar_listviewmultichoice, null);
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.id_menu_draw:
                    ...
                    Toast.makeText(MainActivity_origin.this, "你选中的position有：" + checkedItemString, Toast.LENGTH_SHORT).show();
                    break;
            }
            return true;
        }
